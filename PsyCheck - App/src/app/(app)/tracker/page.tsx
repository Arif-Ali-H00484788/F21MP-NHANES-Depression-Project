...
export default function TrackerPage() {
  const lifestyleGoals = [
    ...
    { id: "habit", name: "Custom Habit", icon: Target, unit: "status", type: "checkbox", placeholder: "Meditate for 10 mins" },
      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="p-4 sm:p-6"> {/* Consistent padding */}
          <div className="mb-4 sm:mb-6">
            ...
            <Input type="date" id="date-picker" defaultValue={new Date().toISOString().split('T')[0]} className="mt-1.5 w-full max-w-xs sm:max-w-sm text-sm sm:text-base"/>
          </div>
